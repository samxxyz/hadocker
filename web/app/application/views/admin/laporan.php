<div class="row mt-4" ng-app="app" ng-controller="laporanController">
    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-primary caridata" style="margin-left: 5px"
                                        data-Url="<?= base_url()?>admin/laporan/getprint"><i
                                            class="fa fa-search" ng-click="Cari()" ></i></button>
                                            <button class="btn btn-primary" id="printButton" style="margin-left: 3px">Print</button>
                                </div>
                            </div>
                        </div>
                    </div>
