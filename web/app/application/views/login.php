...
<body class="hold-transition login-page">
  ...
  <div class="login-box sidebar">
    <div class="login-logo">
    <img src="<?= base_url();?>assets/dist/img/laundryy.png" alt="AdminLTE Logo"
          class="brand-image " style="opacity: 100" width="100">
      <h3>H&M LAUNDRY</h3>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="<?= base_url();?>authorization/login" method="post">
          ...
          <div class="justify-content-between">
            <div>
              <button type="submit" class="btn btn-primary btn-block" style="margin-top: 0 !important ;">Sign in</button>
            </div>
    ...
    <p class="login-box-msg">Belum punya akun? <a href="<?= base_url()?>authorization/registrasi">Registrasi.</a></p>
  </div>
